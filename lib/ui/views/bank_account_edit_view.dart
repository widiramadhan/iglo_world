...
class EditBankView extends StatefulWidget {
  String accountName, bankId, accountNumber;

  EditBankView({Key key, this.accountName, this.bankId, this.accountNumber});

  @override
  _EditBankViewState createState() => _EditBankViewState();
}

class _EditBankViewState extends State<EditBankView> {
  ...
  DropdownButton _dropdownListBank() => DropdownButton(
    hint: new Text("Select Bank", style: TextStyle(fontSize: 12),maxLines: 1, overflow: TextOverflow.ellipsis,),
  ...
  Widget build(BuildContext context) {
    _txtAccountName.text = widget.accountName;
    _txtAccountNumber.text = widget.accountNumber;
    _valueBank = widget.bankId;
    ...
    return BaseView<HomeViewModel>(
      builder: (context, model, child) =>
          Scaffold(
            ...
            appBar: AppBarWidget(title: "Edit Bank Account",
